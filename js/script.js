...
const config = {
    serverInfo: {
        serverLogoImageFileName: "pianet.png", /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        serverName: "PlanetMC", /*Server name*/
        serverIp: "planetmc.kozow.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
